...
if createOperation; then
  ...
  readParameter "CONTROLLER_API_KEY - Please provide the value for the controller api-key. If left blank, a 32 character long base64 encoded value will be randomly generated using openssl:" CONTROLLER_API_KEY $(generateKey 32) "false"
else
  # Secrets are removed from the configurations during update operations ...
  printStatusMsg "Update operation detected ...\nSkipping the prompts for the CR_AGENT_ADMIN_URL, CR_ADMIN_API_KEY and CONTROLLER_API_KEY secrets ...\n"
  # Prompted
  writeParameter "CR_AGENT_ADMIN_URL" "generation_skipped" "false"
  writeParameter "CR_ADMIN_API_KEY" "generation_skipped" "false"
  writeParameter "CONTROLLER_API_KEY" "generation_skipped" "false"
fi
